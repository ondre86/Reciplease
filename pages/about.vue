<template>
	<div id="app-wrap">
		<main class="flex flex-col justify-start items-center px-6 gap-8 mb-12">
			...
			<div class="mt-6">
				<p class="text-xs text-center max-w-xl disclaimer">
					Reciplease does not claim to own any recipe nor any images displayed throughout the site. 
					All recipe content is provided by generative artificial intelligence and images are provided by search engines. 
					Images or recipe content may contain inaccuracies due to errors with artificial intelligence. 
					Reciplease is not liable for any misleading or inaccurate information generated by third-party artificial intelligence APIs or displayed by third-party search engine APIs. 
				</p>
			</div>
		</main>
	</div>
