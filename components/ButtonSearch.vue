<template>
    <div 
        class="flex text-xs close-btn w-fit h-fit p-3 rounded-full ring-1 transition-all duration-300 z-30" 
        tabindex="0" 
        role="button"
    >
    <slot></slot>
    <svg viewBox="0 0 12 9" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="arrow">
