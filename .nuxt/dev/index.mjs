import process from 'node:process';globalThis._importMeta_={url:import.meta.url,env:process.env};import { getRequestHeader, splitCookiesString, setResponseStatus, setResponseHeader, send, getRequestHeaders, defineEventHandler, handleCacheHeaders, createEvent, fetchWithEvent, isEvent, eventHandler, getResponseStatus, setResponseHeaders, setHeaders, sendRedirect, proxyRequest, createError, getRequestHost, getRequestProtocol, getQuery as getQuery$1, getResponseHeader, removeResponseHeader, handleCors, getRequestIP, readMultipartFormData, readBody, setHeader, getHeader, getRequestURL, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getResponseStatusText, H3Error } from 'file:///Users/dre/Code/Reciplease/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import fs, { mkdirSync } from 'node:fs';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { parentPort, threadId } from 'node:worker_threads';
import defu$1, { defu, defuFn, createDefu } from 'file:///Users/dre/Code/Reciplease/node_modules/defu/dist/defu.mjs';
import { html as html$1 } from 'file:///Users/dre/Code/Reciplease/node_modules/satori-html/dist/index.js';
import { withQuery, joinURL, withTrailingSlash, hasProtocol, withHttps, withoutTrailingSlash, parseURL, withoutBase, getQuery, joinRelativeURL, withoutProtocol, withLeadingSlash, withBase, withoutLeadingSlash, parsePath, parseQuery, stringifyQuery, encodePath, stringifyParsedURL } from 'file:///Users/dre/Code/Reciplease/node_modules/ufo/dist/index.mjs';
import sizeOf from 'file:///Users/dre/Code/Reciplease/node_modules/image-size/dist/index.js';
import { consola, createConsola } from 'file:///Users/dre/Code/Reciplease/node_modules/consola/dist/index.mjs';
import { Launcher } from 'file:///Users/dre/Code/Reciplease/node_modules/chrome-launcher/dist/index.js';
import playwrightCore from 'file:///Users/dre/Code/Reciplease/node_modules/playwright-core/index.mjs';
import OpenAI from 'file:///Users/dre/Code/Reciplease/node_modules/openai/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/dre/Code/Reciplease/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, parse, uneval } from 'file:///Users/dre/Code/Reciplease/node_modules/devalue/index.js';
import destr from 'file:///Users/dre/Code/Reciplease/node_modules/destr/dist/index.mjs';
import { renderToString } from 'file:///Users/dre/Code/Reciplease/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file:///Users/dre/Code/Reciplease/node_modules/@unhead/ssr/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin, createHeadCore } from 'file:///Users/dre/Code/Reciplease/node_modules/unhead/dist/index.mjs';
import { isVNode, toValue, version, unref } from 'file:///Users/dre/Code/Reciplease/node_modules/vue/index.mjs';
import { defineHeadPlugin } from 'file:///Users/dre/Code/Reciplease/node_modules/@unhead/shared/dist/index.mjs';
import { createHooks } from 'file:///Users/dre/Code/Reciplease/node_modules/hookable/dist/index.mjs';
import { $fetch as $fetch$1, createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/dre/Code/Reciplease/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/dre/Code/Reciplease/node_modules/unenv/runtime/fetch/index.mjs';
import { klona } from 'file:///Users/dre/Code/Reciplease/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///Users/dre/Code/Reciplease/node_modules/scule/dist/index.mjs';
import { createStorage, prefixStorage, normalizeKey } from 'file:///Users/dre/Code/Reciplease/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/dre/Code/Reciplease/node_modules/unstorage/drivers/fs.mjs';
import lruCacheDriver from 'file:///Users/dre/Code/Reciplease/node_modules/unstorage/drivers/lru-cache.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/dre/Code/Reciplease/node_modules/radix3/dist/index.mjs';
import { getContext } from 'file:///Users/dre/Code/Reciplease/node_modules/unctx/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/dre/Code/Reciplease/node_modules/errx/dist/index.js';
import devalue from 'file:///Users/dre/Code/Reciplease/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { webcrypto } from 'node:crypto';
import { FilterXSS } from 'file:///Users/dre/Code/Reciplease/node_modules/xss/lib/index.js';
import { readFile } from 'node:fs/promises';
import { diffLines } from 'file:///Users/dre/Code/Reciplease/node_modules/diff/lib/index.mjs';
import MagicString from 'file:///Users/dre/Code/Reciplease/node_modules/magic-string/dist/magic-string.es.mjs';
import Fuse from 'file:///Users/dre/Code/Reciplease/node_modules/fuse.js/dist/fuse.mjs';
import { resolve as resolve$1, basename } from 'file:///Users/dre/Code/Reciplease/node_modules/pathe/dist/index.mjs';
import { hash } from 'file:///Users/dre/Code/Reciplease/node_modules/ohash/dist/index.mjs';
import { getIcons } from 'file:///Users/dre/Code/Reciplease/node_modules/@iconify/utils/lib/index.mjs';
import { collections } from 'file:///Users/dre/Code/Reciplease/.nuxt/nuxt-icon-server-bundle.mjs';
import { createGenerator } from 'file:///Users/dre/Code/Reciplease/node_modules/@unocss/core/dist/index.mjs';
import presetWind from 'file:///Users/dre/Code/Reciplease/node_modules/@unocss/preset-wind/dist/index.mjs';
import { Resvg } from 'file:///Users/dre/Code/Reciplease/node_modules/@resvg/resvg-js/index.js';
import _satori from 'file:///Users/dre/Code/Reciplease/node_modules/satori/dist/index.js';
...
const _Y3l1GCPKZd = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script$1}<\/script>`);
  });
});

const rootDir = "/Users/dre/Code/Reciplease";
...
const _T7wRQxuPNP = defineNitroPlugin(async (nitroApp) => {
...
const _ZvFuuolXLL = defineNitroPlugin(async (nitroApp) => {
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    ...
    "nuxt-link-checker": {
      ...
      "rootDir": "/Users/dre/Code/Reciplease",
  ...
  "openAIKey": "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",
...
const serverAssets = [{"baseName":"nuxt-og-image:fonts","dir":"/Users/dre/Code/Reciplease/.nuxt/cache/nuxt-og-image@4.0.1/_fonts"},{"baseName":"server","dir":"/Users/dre/Code/Reciplease/server/assets"}];
...
storage$1.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/dre/Code/Reciplease","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/dre/Code/Reciplease/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/dre/Code/Reciplease/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/dre/Code/Reciplease/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/dre/Code/Reciplease/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const componentNames = [{"hash":"i0Vxmj8bqg","pascalName":"BrandedLogo","kebabName":"branded-logo","path":"/Users/dre/Code/Reciplease/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/BrandedLogo.vue","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"},{"hash":"tBHg51xiAt","pascalName":"Frame","kebabName":"frame","path":"/Users/dre/Code/Reciplease/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Frame.vue","category":"community","credits":"@arashsheyda <https://github.com/arashsheyda>"},{"hash":"Sqc3OTP2KQ","pascalName":"Nuxt","kebabName":"nuxt","path":"/Users/dre/Code/Reciplease/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Nuxt.vue","category":"community","credits":"NuxtLabs <https://nuxtlabs.com/>"},{"hash":"ZZYBOVCtCQ","pascalName":"NuxtSeo","kebabName":"nuxt-seo","path":"/Users/dre/Code/Reciplease/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/NuxtSeo.vue","category":"community","credits":"Nuxt SEO <https://nuxtseo.com/>"},{"hash":"q432NYEB0T","pascalName":"Pergel","kebabName":"pergel","path":"/Users/dre/Code/Reciplease/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Pergel.vue","category":"community","credits":"Pergel <https://nuxtlabs.com/>"},{"hash":"6bQOH7FKu2","pascalName":"SimpleBlog","kebabName":"simple-blog","path":"/Users/dre/Code/Reciplease/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/SimpleBlog.vue","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"},{"hash":"wt558K6QyQ","pascalName":"UnJs","kebabName":"un-js","path":"/Users/dre/Code/Reciplease/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/UnJs.vue","category":"community","credits":"UnJS <https://unjs.io/>"},{"hash":"6RdQZcuwZZ","pascalName":"Wave","kebabName":"wave","path":"/Users/dre/Code/Reciplease/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Wave.vue","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"},{"hash":"gaB1TrbtTl","pascalName":"WithEmoji","kebabName":"with-emoji","path":"/Users/dre/Code/Reciplease/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/WithEmoji.vue","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"}];
...
const _eMQsfR9aJz = defineNitroPlugin(async (nitro) => {
  return;
});
...
const _MA9k3iPyzq = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const _Vj4dsc3tFh = defineNitroPlugin(async (nitroApp) => {
...
const sriHashes = {"/_nuxt/builds/meta/dev.json":"sha384-JgW3TUV+Rn7x6rvwPD9EVfxHZXXwhM+e91U4f+JZHwpk9C/Vfe3ps1PjSMBldC0H","/_nuxt/builds/latest.json":"sha384-OaegCe2q4SShrJwXr+/vLENTeooIqmr0Vrl4d1JtDFq0EWPEZUPWXbbHJIDY14sI","/_robots.txt":"sha384-7QzLcXJHLKmmjPq92C8VAf/JJVMPygySUPdfJryF5BHlJSkEBJP3kG6y29f0ZL1T","/favicon.ico":"sha384-lQUGBZjnRkYaNUwv/A9a4wIegDBvunqIQTr3qjcjsR0ljzDcFR9dEgNVbQQpFTXy","/og-img.jpg":"sha384-icRmpR4nhGKsqwBkvHrtgYDd2wqpNAP+84+9df9KpfWfEhWNwml3vIa4lJNMyoLy"};
...
const _mUdUo8EOIY = defineNitroPlugin((nitroApp) => {
...
const _4rBzI2GRLR = defineNitroPlugin((nitroApp) => {
  {
    return;
  }
});
...
const _BYKMB9ABFj = defineNitroPlugin((nitroApp) => {
...
const _MdVfRbx7kF = defineNitroPlugin((nitroApp) => {
...
const _UvVZkxRjgV = defineNitroPlugin((nitroApp) => {
  {
    return;
  }
});

const _vp1qJHJKkd = defineNitroPlugin((nitroApp) => {
...
const _b0hg7n5RVf = defineNitroPlugin((nitroApp) => {
...
const _zEGm4RVNdR = defineNitroPlugin(async (nitroApp) => {
  {
...
const _QbJZJO = defineEventHandler((event) => {
  const rules = resolveSecurityRules(event);
...
const _DHaVfa = defineEventHandler((event) => {
  const rules = resolveSecurityRules(event);
...
const _AuNAof = defineEventHandler((event) => {
  const rules = resolveSecurityRules(event);
...
const _4rWxYn = defineEventHandler(async (event) => {
  const rules = resolveSecurityRules(event);
...
const _ZWgEBe = defineEventHandler(async (event) => {
  const rules = resolveSecurityRules(event);
...
const _dztAJL = defineEventHandler(async (e) => {
...
const _IhHEvD = defineEventHandler(async (e) => {
  const siteConfig = useSiteConfig(e);
  const nitroOrigin = useNitroOrigin(e);
  const runtimeConfig = useRuntimeConfig(e);
...
const _irjHVI = defineEventHandler(async (e) => {
...
const _fd1HY1 = defineEventHandler(async (e) => {
...
const _PwcQfS = defineEventHandler(async (e) => {
...
const _IkBhZJ = defineEventHandler(async (e) => {
...
const _DYJO24 = defineEventHandler(async (e) => {
...
const _BzD3Uk = defineEventHandler(async (e) => {
...
const _ZDZJh6 = defineEventHandler(async (e) => {
...
const _J9jWeg = defineEventHandler(async (e) => {
  const nitroOrigin = useNitroOrigin(e);
  return {
    nitroOrigin,
...
const _3QlqOx = defineEventHandler(async (e) => {
...
const _i87HT7 = defineCachedEventHandler(async (e) => {
  const runtimeConfig = useRuntimeConfig().public["nuxt-link-checker"] || {};
  const linkDb = [
    ...pagePaths
  ];
...
const _Jm7wOY = defineEventHandler(async (e) => {
  return {
...
const _cD8g4i = defineEventHandler(async (e) => {
  const path = parseURL(e.path).pathname;
  if (fileMapping[path]) {
...
const _x4RBAj = defineCachedEventHandler(async (event) => {
...
const _lazy_ZKgu4e = () => Promise.resolve().then(function () { return index; });
const _lazy_ngDz4I = () => Promise.resolve().then(function () { return renderer$1; });
const _lazy_CNpKip = () => Promise.resolve().then(function () { return font$1; });
const _lazy_ikiW4X = () => Promise.resolve().then(function () { return debug_json$1; });
const _lazy_RvrU76 = () => Promise.resolve().then(function () { return image$1; });

const handlers = [
  { route: '/api', handler: _lazy_ZKgu4e, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_ngDz4I, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _QbJZJO, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _DHaVfa, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _AuNAof, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _4rWxYn, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _ZWgEBe, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _dztAJL, lazy: false, middleware: true, method: undefined },
  { route: '/__site-config__/debug.json', handler: _IhHEvD, lazy: false, middleware: false, method: undefined },
  { route: '/robots.txt', handler: _irjHVI, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _fd1HY1, lazy: false, middleware: true, method: undefined },
  { route: '/__robots__/debug.json', handler: _PwcQfS, lazy: false, middleware: false, method: undefined },
  { route: '/__robots__/debug-path.json', handler: _IkBhZJ, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug.json', handler: _DYJO24, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _BzD3Uk, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _ZDZJh6, lazy: false, middleware: false, method: undefined },
  { route: '/__og-image__/font/**', handler: _lazy_CNpKip, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/debug.json', handler: _lazy_ikiW4X, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/image/**', handler: _lazy_RvrU76, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/static/**', handler: _lazy_RvrU76, lazy: true, middleware: false, method: undefined },
  { route: '/__schema-org__/debug.json', handler: _J9jWeg, lazy: false, middleware: false, method: undefined },
  { route: '/__link-checker__/inspect', handler: _3QlqOx, lazy: false, middleware: false, method: undefined },
  { route: '/__link-checker__/links', handler: _i87HT7, lazy: false, middleware: false, method: undefined },
  { route: '/__link-checker__/debug.json', handler: _Jm7wOY, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _cD8g4i, lazy: false, middleware: true, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _x4RBAj, lazy: false, middleware: false, method: undefined },
  { route: '/_fonts/**', handler: _lazy_ngDz4I, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_ngDz4I, lazy: true, middleware: false, method: undefined }
];
...
async function useSharp() {
  sharpInstance.instance = sharpInstance.instance || await import('file:///Users/dre/Code/Reciplease/node_modules/unenv/runtime/mock/empty.mjs').then((m) => m.default);
  return sharpInstance.instance;
}
async function useCssInline() {
  cssInlineInstance.instance = cssInlineInstance.instance || await import('file:///Users/dre/Code/Reciplease/node_modules/unenv/runtime/mock/empty.mjs').then((m) => m.default);
...
const getClientManifest = () => import('file:///Users/dre/Code/Reciplease/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/dre/Code/Reciplease/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
