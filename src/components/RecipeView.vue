            ...
            <div class="ingredients py-6 px-8 rounded-xl border shadow-2xl w-80">
                <div class="flex flex-col gap-4">
                    ...
                    <ButtonPrimary 
                        ...
                        :class="[shoppingListButtonText == `Added!` ? 'opacity-45' : 'opacity-100', shoppingListButtonText == `Added!` ? 'cursor-not-allowed' : 'cursor-pointer']"
...
const minServingSize = x.recipes[0].servingSize.minServings
...
onMounted(()=>{
    ...
    console.log(tempShoppingList.value)
})
</script>
