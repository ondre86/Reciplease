<template>
    <div class="checkbox-wrapper-1 flex items-center">
        <input class="substituted" type="checkbox" aria-hidden="true" :id=ingredient.ingredient :name="ingredient.ingredient" :value="ingredient.ingredient"/>
        <label class="text-lg flex" :for="ingredient.ingredient">
            <div class="flex flex-col gap-1">
                <span>{{ ingredient.ingredient }}</span>
                <span class="italic text-sm">{{ ingredient.quantity }} {{ ingredient.measurement }}</span>
            </div>
        </label>
    </div>
</template>
